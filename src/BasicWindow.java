...
public class BasicWindow{
	...
	public BasicWindow(){
        ...
        JPanel card2 = playWindow(playerName1, playerName2);
	...
	public JPanel startWindow(final JPanel cards) {
		...
		OkButton.addActionListener(new ActionListener() {
		   	public void actionPerformed(ActionEvent e) {     
				...
				setProceed(true);
				playWindow(playerName1, playerName2);
	...
	public JPanel playWindow(String playerName1, String playerName2) {
		CardLayout cardLayout = (CardLayout) cards.getLayout();
		...
		setPlayer1Status(player1, p1Label, playerName1);
		
		JLabel gameLabel = new JLabel();
		setGameText(gameLabel);
		JLabel p2Label = new JLabel();
		setPlayer2Status(player2, p2Label, playerName2);
	...
	public void setPlayer1Status(Player player1, JLabel status, String playerName1) {
		score = player1.getScore();
		status.setText(playerName1 + "(P1): " + score);
	}
	
	public void setPlayer2Status(Player player2, JLabel status, String playerName2) {
